...
<html>
    <head>
        ...
        <script src="JS/scripts-SE3.js"></script>
    ...
    <body>
        ...
        <div id="Cue_Num_back"><div id="Cue_Num_Num"></div></div>
            ...
            <div id="SE_BTN">
                ...
                <?php
                    ...
                    for ($i=1; $i<=intval($stg[3]) ;$i++){
                        echo '<button type="submit" id="SE_BTN_' . $i . '" class="SE_btn" name="SE_Answer_F" value="#fff"></button>';
                    }

                ?>

                <br>
                <button type="submit" id="SE_BTN_0" class="SE_btn" name="SE_Answer_F" value="#fff" style="display: none;">هیچکدام</button>
